...
import type { ArtefactInput, MeetingHubPlugin, PluginResult } from '@swarmai/meeting-hub-sdk';

export const pdfReader: MeetingHubPlugin = {
  manifest: {
    id: 'pdf-reader',
    version: '1.0.0',
  ...
  async onArtefactShared(input: ArtefactInput): Promise<PluginResult> {
    ...
    let parser: typeof import('pdf-parse').default;
    try {
    ...
    let parsed: Awaited<ReturnType<typeof parser>>;
    try {
